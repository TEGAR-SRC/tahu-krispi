// Shared ticket chat primitives – mirrors console-admin/src/components/shared/TicketChat.tsx
// Keeps customer chat visually and behaviorally identical to staff chat.
...
export function authorLabel(
  ...
  if (t === "staff") return opts?.viewer === "customer" ? "Support" : "staff"
