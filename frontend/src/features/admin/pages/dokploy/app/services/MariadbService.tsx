...
export default function DokployMariadbServicePage() {
  const projectId = useParams().projectId
  const environmentId = useParams().environmentId
  const serviceId = useParams().serviceId
  return (
    <div className="flex flex-col gap-6">
      <PageHeader title="MariaDB" />
      <EmptyState
        message="This page has not been wired to the upstream API yet."
        description="Implementation pending for route /admin/dokploy/app/p/:projectId/e/:environmentId/services/mariadb/:serviceId."/>
